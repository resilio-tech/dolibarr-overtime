...
/**
 *   	\file       overtime_list.php
 *		\ingroup    overtime
 *		\brief      List page for overtime
 */
...
//	$permissiontoadd = $user->hasRight('overtime', 'overtime', 'write');
//	$permissiontodelete = $user->hasRight('overtime', 'overtime', 'delete');
//} else {
//	$permissiontoread = 1;
//	$permissiontoadd = 1;
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/overtime/overtime_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendOvertimeRef";
$modelmail = "overtime";
...
if ($search_all) {
	...
	print '<!-- Search done like if OVERTIMEHOURSKEEP_QUICKSEARCH_ON_FIELDS = '.$setupstring.' -->'."\n";
