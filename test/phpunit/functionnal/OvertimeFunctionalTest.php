...
/**
 * \file    test/phpunit/OvertimeFunctionalTest.php
 * \ingroup overtime
 ...
 *
 * @package Testovertime
 */
class OvertimeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/overtime/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('overtime/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/overtime/admin/about.php');
		$this->authenticate();
		return $this->assertContains('overtime/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('overtimewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modOvertime_OvertimeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modOvertime_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
